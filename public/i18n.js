...
var I18N = (function() {
  ...
  var T = {
    ...
    staff_scanner:      { fr:'Scanner', en:'Scanner', es:'Escáner', it:'Scanner', de:'Scanner', pt:'Scanner' },
    staff_ar_tools:     { fr:'AR Tools', en:'AR Tools', es:'AR Tools', it:'AR Tools', de:'AR Tools', pt:'AR Tools' },
    ...
    staff_encaisser:    { fr:'Encaisser', en:'Checkout', es:'Cobrar', it:'Incassare', de:'Kassieren', pt:'Cobrar' },
    ...
    staff_agenda:       { fr:'Agenda', en:'Calendar', es:'Agenda', it:'Agenda', de:'Kalender', pt:'Agenda' },
